...
The buttons should visually resemble the original game menu buttons.

### Reference Screenshot

The homepage design is based on a RotWK main menu screenshot.
...
The maps page is the main functional page of the website.

It should look simpler and more oldschool than the homepage.
